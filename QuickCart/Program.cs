...
using QuickCart.DataAccess.DbInitializer;
...
builder.Services.AddIdentity<IdentityUser, IdentityRole>().AddEntityFrameworkStores<QuickCartDbContext>().AddDefaultTokenProviders();
